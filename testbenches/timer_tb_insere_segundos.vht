...
-- Insere segundos:
--  Insere um valor de segundos maior que 59
--  realiza a contagem desse valor até 0
insere_segundos : PROCESS                                               
	-- 78 segundos => 78 ciclos de 1 Hz
	-- Arrendondar para 80 ciclos
	constant n_ciclos_contagem : integer := 80;
